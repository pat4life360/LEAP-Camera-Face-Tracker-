...
CVPY_TYPE(cuda_GpuData, Ptr<cv::cuda::GpuData>, Ptr, NoBase, 0);
CVPY_TYPE(cuda_GpuMatND, Ptr<cv::cuda::GpuMatND>, Ptr, NoBase, 0);
...
CVPY_TYPE(segmentation_IntelligentScissorsMB, cv::segmentation::IntelligentScissorsMB, IntelligentScissorsMB, NoBase, pyopencv_cv_segmentation_segmentation_IntelligentScissorsMB_IntelligentScissorsMB);
...
CVPY_TYPE(dnn_Model, cv::dnn::Model, Model, NoBase, pyopencv_cv_dnn_dnn_Model_Model);
...
CVPY_TYPE(dnn_KeypointsModel, cv::dnn::KeypointsModel, KeypointsModel, dnn_Model, pyopencv_cv_dnn_dnn_KeypointsModel_KeypointsModel);
CVPY_TYPE(dnn_SegmentationModel, cv::dnn::SegmentationModel, SegmentationModel, dnn_Model, pyopencv_cv_dnn_dnn_SegmentationModel_SegmentationModel);
...
CVPY_TYPE(dnn_TextRecognitionModel, cv::dnn::TextRecognitionModel, TextRecognitionModel, dnn_Model, pyopencv_cv_dnn_dnn_TextRecognitionModel_TextRecognitionModel);
CVPY_TYPE(dnn_TextDetectionModel, cv::dnn::TextDetectionModel, TextDetectionModel, dnn_Model, 0);
CVPY_TYPE(dnn_TextDetectionModel_EAST, cv::dnn::TextDetectionModel_EAST, TextDetectionModel_EAST, dnn_TextDetectionModel, pyopencv_cv_dnn_dnn_TextDetectionModel_EAST_TextDetectionModel_EAST);
CVPY_TYPE(dnn_TextDetectionModel_DB, cv::dnn::TextDetectionModel_DB, TextDetectionModel_DB, dnn_TextDetectionModel, pyopencv_cv_dnn_dnn_TextDetectionModel_DB_TextDetectionModel_DB);
...
CVPY_TYPE(wechat_qrcode_WeChatQRCode, Ptr<cv::wechat_qrcode::WeChatQRCode>, Ptr, NoBase, pyopencv_cv_wechat_qrcode_wechat_qrcode_WeChatQRCode_WeChatQRCode);
...
CVPY_TYPE(ccm_ColorCorrectionModel, Ptr<cv::ccm::ColorCorrectionModel>, Ptr, NoBase, pyopencv_cv_ccm_ccm_ColorCorrectionModel_ColorCorrectionModel);
...
CVPY_TYPE(large_kinfu_Params, Ptr<cv::large_kinfu::Params>, Ptr, NoBase, 0);
CVPY_TYPE(large_kinfu_LargeKinfu, Ptr<cv::large_kinfu::LargeKinfu>, Ptr, NoBase, 0);
...
CVPY_TYPE(kinfu_VolumeParams, Ptr<cv::kinfu::VolumeParams>, Ptr, NoBase, 0);
...
CVPY_TYPE(Tracker, Ptr<cv::Tracker>, Ptr, NoBase, 0);
CVPY_TYPE(TrackerMIL, Ptr<cv::TrackerMIL>, Ptr, Tracker, 0);
CVPY_TYPE(TrackerMIL_Params, cv::TrackerMIL::Params, Params, NoBase, pyopencv_cv_TrackerMIL_Params_TrackerMIL_Params);
CVPY_TYPE(TrackerGOTURN, Ptr<cv::TrackerGOTURN>, Ptr, Tracker, 0);
CVPY_TYPE(TrackerGOTURN_Params, cv::TrackerGOTURN::Params, Params, NoBase, pyopencv_cv_TrackerGOTURN_Params_TrackerGOTURN_Params);
...
CVPY_TYPE(xfeatures2d_BEBLID, Ptr<cv::xfeatures2d::BEBLID>, Ptr, Feature2D, 0);
...
CVPY_TYPE(xfeatures2d_AffineFeature2D, Ptr<cv::xfeatures2d::AffineFeature2D>, Ptr, Feature2D, 0);
CVPY_TYPE(xfeatures2d_TBMR, Ptr<cv::xfeatures2d::TBMR>, Ptr, xfeatures2d_AffineFeature2D, 0);
...
CVPY_TYPE(GOpaqueT, cv::GOpaqueT, GOpaqueT, NoBase, pyopencv_cv_GOpaqueT_GOpaqueT);
CVPY_TYPE(GArrayT, cv::GArrayT, GArrayT, NoBase, pyopencv_cv_GArrayT_GArrayT);
...
CVPY_TYPE(GArrayP2f, cv::GArrayP2f, GArrayP2f, NoBase, 0);
...
CVPY_TYPE(TrackerCSRT_Params, cv::TrackerCSRT::Params, Params, NoBase, pyopencv_cv_TrackerCSRT_Params_TrackerCSRT_Params);
CVPY_TYPE(TrackerKCF, Ptr<cv::TrackerKCF>, Ptr, Tracker, 0);
CVPY_TYPE(TrackerKCF_Params, cv::TrackerKCF::Params, Params, NoBase, pyopencv_cv_TrackerKCF_Params_TrackerKCF_Params);
CVPY_TYPE(legacy_Tracker, Ptr<cv::legacy::Tracker>, Ptr, Algorithm, 0);
CVPY_TYPE(legacy_TrackerMIL, Ptr<cv::legacy::TrackerMIL>, Ptr, legacy_Tracker, 0);
CVPY_TYPE(legacy_TrackerBoosting, Ptr<cv::legacy::TrackerBoosting>, Ptr, legacy_Tracker, 0);
CVPY_TYPE(legacy_TrackerMedianFlow, Ptr<cv::legacy::TrackerMedianFlow>, Ptr, legacy_Tracker, 0);
CVPY_TYPE(legacy_TrackerTLD, Ptr<cv::legacy::TrackerTLD>, Ptr, legacy_Tracker, 0);
CVPY_TYPE(legacy_TrackerKCF, Ptr<cv::legacy::TrackerKCF>, Ptr, legacy_Tracker, 0);
CVPY_TYPE(legacy_TrackerMOSSE, Ptr<cv::legacy::TrackerMOSSE>, Ptr, legacy_Tracker, 0);
CVPY_TYPE(legacy_MultiTracker, Ptr<cv::legacy::MultiTracker>, Ptr, Algorithm, pyopencv_cv_legacy_legacy_MultiTracker_MultiTracker);
CVPY_TYPE(legacy_TrackerCSRT, Ptr<cv::legacy::TrackerCSRT>, Ptr, legacy_Tracker, 0);
CVPY_TYPE(stereo_MatchQuasiDense, cv::stereo::MatchQuasiDense, MatchQuasiDense, NoBase, pyopencv_cv_stereo_stereo_MatchQuasiDense_MatchQuasiDense);
CVPY_TYPE(stereo_PropagationParameters, cv::stereo::PropagationParameters, PropagationParameters, NoBase, 0);
CVPY_TYPE(stereo_QuasiDenseStereo, Ptr<cv::stereo::QuasiDenseStereo>, Ptr, NoBase, 0);
